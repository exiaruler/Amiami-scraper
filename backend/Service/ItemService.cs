...
public class ItemService : BaseService
{
    ...
    public async Task<List<Item>> GetItemsByTagAsync(string search, Boolean sold)
    {
    ...
    public async Task<List<Item>> GetItemsWide(string search, Boolean sold)
    {
    ...
    public async Task<string> AmiamiUpdate(AmiamiJson batchJsonString)
    {
        string result = "ok";
        ...
        if (jsonObj != null)
        {
            ...
            else result="Wishlist does not exist";

        }
        else result = "Object error";
        return result;
